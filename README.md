...
- [Dograh](https://www.dograh.com) - Dograh is a Fully Open Source alternative to Vapi and Bland AI. Created and maintained by YC alumni and Exit Founders, Dograh puts the power back in your hands, not Big Tech's. Dograh AI lets developers build conversational voice agents in under 2 minutes using plain English for inbound/outbound calling: customer support, appointment scheduling, lead qualification, payment reminders, and more. Bring your own LLM/TTS/STT keys and test bots with AI-to-AI conversations. Fully open-source, self-hostable, giving you control over your voice AI infrastructure—no vendor lock-in. Advocating that voice tech should be free and accessible to all.
  
- **Tags**: `Free` `Open Source` `Voice` `Audio & Speech` `Conversational AI` `Developer Tool`
  
- **Pricing**: Free
  
- **GitHub**: https://github.com/dograh-hq/dograh
  
- **Contact**: https://join.slack.com/t/dograh-community/shared_invite/zt-3czr47sw5-MSg1J0kJ7IMPOCHF~03auQ

- [ElevenLabs](https://elevenlabs.io/) - Realistic AI voice synthesis and cloning.
  
- **Tags**: `Free` `Subscription` `AI` `Voice` `TTS`
  
- **Pricing**: Free tier, Paid

- [Murf.ai](https://murf.ai/) - AI voice generator for professional voiceovers.
  
- **Tags**: `Free` `Subscription` `AI` `Voice` `Voiceover`
  
- **Pricing**: Free trial, Paid

- [Play.ht](https://play.ht/) - Ultra-realistic AI voice generation platform.
  
- **Tags**: `Free` `Subscription` `AI` `Voice` `TTS`
  
- **Pricing**: Free tier, Paid

- [AI speaker](https://ai-speaker.net/) - Convert text to speech with natural-sounding AI voices.
  
- **Tags**: `Free` `AI` `Voice` `TTS`
